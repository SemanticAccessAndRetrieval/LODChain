    ...
    <body>
        ...
        <nav id="menu">
            <ul class="links">
                ...
                <li><a href="https://www.youtube.com/watch?v=vwKu5nVnjoM">Tutorial Video</a></li>
        ...
        <section id="One" class="wrapper style3">
            <div class="inner">
                <header class="align-center">
                    <p style="font-size:1.8rem">LODChain</p>
     ...
     <section id="one" class="wrapper style2">
       ...
       <div id="choices" style=" display: flex;
                justify-content: center; ">
                   
                    <img style="width:70%;  background-color:white;  border: 2px solid #0e3d74; border-radius: 2%;"  src="images/connectionCheckerIntro.png">
                </div>
                
                 <div id="choices2" style=" display: flex;
                justify-content: center;">
                <a href="input.jsp" class="buttonStart">Start</a> 
                 <a href="moreInformation.jsp" class="buttonStart" style='float:right'>About</a>
                <br>
