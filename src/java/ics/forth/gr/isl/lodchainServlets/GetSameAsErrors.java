 ...
 */
public class GetSameAsErrors extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"sameAsErrors.txt\"");
        try {
            OutputStream outputStream = response.getOutputStream();
            ArrayList<String> results = new ArrayList<String>();
            LODChainController lov = new LODChainController();
            HttpSession session = request.getSession();
            String outputResult = session.getAttribute("errors").toString();
